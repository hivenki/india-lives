...
<html>
<head>
<title>All that men at gates need to know</title>
...
<table border="0" width="100%" height="84%" style="margin-top: 5px">
	...
	<%@include file="contentPage.jsp" %>	
	 ...
	 <td  valign="top"  height="100%">	
	  ...
	  <legend class="indiaLivesFonts" >Security Team</legend>
		...
		<tr class="indiaLivesFonts" valign="top">
			<td>
				Know expected visitors for a flat		
			</td>
		</tr>
		<tr class="indiaLivesFonts">
				<td> Communicate with society management</td>
		 </tr>								
		</table>	
	</form>
	</fieldset>
