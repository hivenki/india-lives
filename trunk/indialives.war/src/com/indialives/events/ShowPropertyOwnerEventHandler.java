...
public class ShowPropertyOwnerEventHandler implements EventHandler,PageNameConstants,SetAttributeConstants {
	...
	public void forward(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher(ADD_PROPERTY_OWNER);
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute(USER_LIST_FOR_PROPERTY,userForPropertyList);
