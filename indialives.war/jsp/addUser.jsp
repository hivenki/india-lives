  ...
  <tr>
	...
	<fieldset style="height: 100%;width: 100%">
	 <legend style="font-size:16px;">Create User</legend>
		...
		<tr>
		<td  class="indiavlives" style="text-indent: 100px;font-size: 16px">
		We'll get you set up on IndiaLives! in the following step! 
		</td>
		</tr>    	
		<tr>
		<td  class="indiavlives" style="text-indent: 100px;font-size: 16px">
		Just fill the below form, provide an email id and password, and you'll be all set.
		</td>
		</tr>
		</table>
